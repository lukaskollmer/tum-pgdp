...
public class Videotest extends MiniJava {
  ...
  public static String printVideo(Main_Task_04.Video v) {
    return "Video{" + "titel='" + v.getTitel() + '\'' + ", id=" + v.getId() + ", genres="
        + Arrays.toString(v.getGenres()) + '}';
  }

  public static String printVideosammlung(Main_Task_04.Videosammlung vhs) {
    String s = "";
    Main_Task_04.Video[] videos = vhs.getVideos();
  ...
  public static void main(String[] args) {
    ...
    Main_Task_04.Videosammlung vhs = new Main_Task_04.Videosammlung(20);
    for (int i = 0; i < 20; i++) {
      Main_Task_04.Video v = new Main_Task_04.Video("titel-" + i);
      for (int j = 0; j < (i % 5); j++) {
        v.addGenre("g-" + (j + 1));
      }
    ...
    Main_Task_04.Video v = new Main_Task_04.Video("Darf nicht reinpassen");
    int result = vhs.addVideo(v);
    if (result != -1) {
    ...
    v = new Main_Task_04.Video("Darf nicht reinpassen");
