...
public interface Visitor {
    ...
    void visit(ExpressionStatement expressionStatement) throws Error;
    ...
    void visit(ObjectInitialization objectAllocation) throws Error;

    void visit(InstanceMethodCall instanceMethodCall) throws Error;
}
