...
import static task_06.Util.f;   // String.format
...
public class CodeGenerationVisitor implements Visitor {
    ...
    public void visit(Program program) throws Error {
        ...
        // 1.1 check for duplicate symbols
    ...
    public void visit(If ifStatement) throws Error {
        java.util.function.Function<String, String> generateIfLabel = type -> f("%s_if_%02d_body_%s", this.functionName, this.if_while_counter, type);
    ...
    public void visit(While whileStatement) throws Error {
        java.util.function.Function<String, String> generateLabel = type -> f("%s_while_%02d_%s", this.functionName, this.if_while_counter, type);
